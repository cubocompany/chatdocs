    ...
    <main className="mx-auto max-w-7xl md:p-10">
      ...
      {files && files.length !== 0 ? (
          ...
          {files
            ...
            .map((file) => (
              <li
                ...
                <div className="mt-4 grid grid-cols-3 place-items-center gap-6 px-6 py-2 text-sm text-zinc-500">
        ...
        <div className="mt-16 flex flex-col items-center gap-2">
          ...
          <h3 className="text-xl font-semibold">Está meio vazio por aqui.</h3>
